...
GGUF_CONFIG_MAPPING = {
    ...
    "qwen4_exp_text": {
        ...
        "attention.layer_norm_rms_epsilon": "rms_norm_eps",
        "attention.recurrent_layers": "_gguf_recurrent_layers",
        "attention.compress_ratios": "_gguf_attention_compress_ratios",
        "full_attention_interval": "_gguf_full_attention_interval",
        "ssm.conv_kernel": "linear_conv_kernel_dim",
        "ssm.state_size": "linear_key_head_dim",
        "ssm.group_count": "linear_num_key_heads",
        ...
        "ple.layers": "_gguf_ple_layers",
        "ple.ngram_size": "ngram_size",
        "ple.heads_per_ngram": "heads_per_ngram",
        "ple.conv_kernel": "ple_conv_kernel_size",
        "ple.eos_token_id": "_gguf_ple_eos_token_id",
        "embedding_length_per_layer_input": "_gguf_ple_head_dim",
        "ple.layer_multipliers": "_gguf_ple_layer_multipliers",
        "ple.head_offsets": "_gguf_ple_head_offsets",
        "ple.head_vocab_sizes": "_gguf_ple_head_vocab_sizes",
        "ple.image_token_id": "image_token_id",
        "vocab_size": "vocab_size",
    },
    "deepseek_v4": {
        "context_length": "max_position_embeddings",
        ...
        "rope.dimension_count": "_gguf_rope_dimension_count",
        "rope.freq_base": "rope_theta",
        "rope.scaling.type": "_gguf_rope_scaling_type",
        "rope.scaling.factor": "_gguf_rope_scaling_factor",
        "rope.scaling.original_context_length": "_gguf_rope_scaling_original_context_length",
        "rope.scaling.yarn_beta_fast": "_gguf_rope_scaling_beta_fast",
        "rope.scaling.yarn_beta_slow": "_gguf_rope_scaling_beta_slow",
        "attention.head_count": "num_attention_heads",
        "attention.head_count_kv": "num_key_value_heads",
        "attention.key_length": "head_dim",
        "attention.value_length": "_gguf_attention_value_length",
        ...
        "expert_feed_forward_length": "moe_intermediate_size",
        "expert_gating_func": "_gguf_expert_gating_func",
        "expert_weights_scale": "routed_scaling_factor",
        "expert_weights_norm": "norm_topk_prob",
        "hash_layer_count": "_gguf_hash_layer_count",
        "swiglu_clamp_exp": "_gguf_swiglu_clamp_exp",
        "swiglu_clamp_shexp": "_gguf_swiglu_clamp_shexp",
...
GGUF_CONFIG_DEFAULTS_MAPPING = {
    ...
    "qwen4_exp_text": {
        ...
        "attn_output_gate": True,
        "hidden_act": "silu",
        # Qwen4-Exp changed the Gated DeltaNet output gate from SiLU to sigmoid.
